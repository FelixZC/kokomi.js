...
export class MeshReflectorMaterialImpl extends MeshStandardMaterial {
  ...
  _hasBlur: { value: boolean };
  _mirror: { value: number };
  _mixBlur: { value: number };
  _blurStrength: { value: number };
  _minDepthThreshold: { value: number };
  _maxDepthThreshold: { value: number };
  _depthScale: { value: number };
  _depthToBlurRatioBias: { value: number };
  _distortion: { value: number };
  _mixContrast: { value: number };
